...
MAKEFILE = mccp1Dynamics_mex.mk

include mccp1Dynamics_mex.mki
...
MEX_FILE_NAME_WO_EXT = mccp1Dynamics_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\mccp1Dynamics"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\mccp1Dynamics/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
