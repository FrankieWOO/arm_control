START_DIR = D:\Dropbox\workspace\ws_matlab\arm_control\models

MATLAB_ROOT = D:\MATLAB\R2017a
MAKEFILE = mccp1TauA_mex.mk

include mccp1TauA_mex.mki


SRC_FILES =  \
	mccp1TauA_data.c \
	mccp1TauA_initialize.c \
...
MEX_FILE_NAME_WO_EXT = mccp1TauA_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\mccp1TauA"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\mccp1TauA/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
